...
/// Specifies the first or second part of an Advent of Code puzzle.
pub enum Part {
    One,
    Two,
}

/// The result of running a solution.
pub struct Answer {
    /// Number of the puzzle (day 1 = 1, etc).
    pub day: usize,
    /// Part of the puzzle.
    pub part: Part,
    /// Output of the solution.
    pub answer: Result<String>,
    /// Amount of time running the solution took.
    pub runtime: std::time::Duration,
}

/// Encapsulates a solution for a single day of Advent of Code.
pub trait Solution {
    /// Name of the file containing the puzzle input.
    fn data_file_name() -> &'static str;
    /// Solution of part 1 of the puzzle.
    fn part1(input: &[&str], output: &mut String) -> Result<()>;
    /// Solution of part 2 of the puzzle.
    fn part2(input: &[&str], output: &mut String) -> Result<()>;
}

/// Runs the solution for the `index`th day, if it exists.
